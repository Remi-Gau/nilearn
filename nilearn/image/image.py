...
def _crop_img_to(img, slices, copy=True):
    ...
    offset : :obj:`list`, optional
        List of tuples representing the number of voxels
...
def load_img(img, wildcards=True, dtype=None):
    ...
    ----------
    img : Niimg-like object
        If string, consider it as a path to NIfTI image
    ...
    3D/4D Niimg-like object
        ...
        has an affine attributes
        and that nilearn.image.get_data returns its data.
