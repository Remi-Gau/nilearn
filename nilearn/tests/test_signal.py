    ...
    for tr1, tr2 in zip(random_tr_list1, random_tr_list2):
        ...
        for low_cutoff, high_cutoff in zip(low_pass_freq_list,
            ...
            if not np.isclose(tr1, tr2, atol=0.3):
                msg = f'results do not differ for different TRs: {tr1} and {tr2} at cutoffs: low_pass={low_cutoff}, high_pass={high_cutoff} n_samples={n_samples}, n_features={n_features}'
