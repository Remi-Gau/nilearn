...
def permuted_ols(
    ...
    tfce_original_data = _get_tfce_original_data(tfce,
                            masker,
                            scores_original_data,
                            bin_struct,
                            two_sided_test)
    ...
    threshold_t = _determine_t_statistic_threshold(threshold,
                                                    n_samples,
                                                    n_regressors,
                                                    n_covars,
                                                    two_sided_test)        
    ...
    if threshold is not None:
        ...
        cluster_dict = _compute_cluster_dict(csfwe_h0_parts,
                                cmfwe_h0_parts,
                                vfwe_pvals,
                                masker,
                                scores_original_data,
...
def _check_for_intercept_in_confounds(confounding_vars, intercept_test, model_intercept): 
...
def _optionally_add_intercept(confounding_vars,
                              model_intercept,
                              intercept_test,
                              n_samples):
...
def _get_tfce_original_data(tfce,
                            masker,
                            scores_original_data,
                            bin_struct,
                            two_sided_test):
    ...
    tfce_original_data = _calculate_tfce(scores_4d,
                                            bin_struct=bin_struct,
                                            two_sided_test=two_sided_test,
    )
    tfce_original_data = apply_mask(        nib.Nifti1Image(
            tfce_original_data,
...
def _determine_t_statistic_threshold(threshold,
                                     n_samples,
                                     n_regressors,
                                     n_covars,
                                     two_sided_test):
...
def _compute_cluster_dict(csfwe_h0_parts,
                          cmfwe_h0_parts,
                          vfwe_pvals,
                          masker,
                          scores_original_data,
...
def _check_arguments_permuted_ols(target_vars, n_jobs, tfce, threshold, masker):
