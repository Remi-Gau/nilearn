...
print(
    "First subject anatomical nifti image (3D) located ",
    f" is at: {haxby_dataset.anat[0]}",
)
print(
...
# data to convert to a new image as output.
...
# To consolidate such brain images towards more compact shapes,
# we use a `morphological dilation
...
# Now, we visualize the same using `plot_roi`
# with data being converted to Nifti image.
